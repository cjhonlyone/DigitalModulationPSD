...
digitalwaveformidxI = randi([1 nASK],T*bps/log2(nASK),1);
digitalwaveformidxQ = randi([1 nASK],T*bps/log2(nASK),1);
digitalwaveformamp = askset(digitalwaveformidxI);
digitalwaveformamp = repmat(digitalwaveformamp', 1, fs/(bps/log2(nASK)));
...
semilogy (fftaxis(fftwilderspec),yASK_fft(fftwilderspec), 'LineWidth',1, 'color',[239/255 143/255 38/255])
hold on
semilogy(fftaxis(fftwilderspec), nASK_psd(nASK, bps, fc, fftaxis(fftwilderspec)*1e6) ,'-' ,...
